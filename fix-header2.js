      ...
      <div class="container" style="display: flex; align-items: center; justify-content: space-between; padding-top: 12px; padding-bottom: 12px;">
        ...
        <div style="display:flex; align-items:center; gap:20px;">
          ...
          <div style="display:flex; align-items:center; background:#fff; border-radius:4px; border:2px solid #0f172a; overflow:hidden; width:300px; box-shadow:0 2px 6px rgba(0,0,0,0.15);">
            ...
            <input type="text" placeholder="Search official records..." style="border:none; padding:10px 0; outline:none; font-size:14px; font-weight:600; width:100%; color:#0f172a; background:transparent;">
...
// Splitting carefully
const parts = code.split('function headerHtml(activeTop){');
if(parts.length > 1) {
  const parts2 = parts[1].split('function footerHtml(){');
  
  if(parts2.length > 1) {
    code = parts[0] + newHeader + '\nfunction footerHtml(){' + parts2[1];
    fs.writeFileSync('index-4.html', code, 'utf8');
    console.log("Header replaced via split successfully.");
  }
}
